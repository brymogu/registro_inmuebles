...
@section('content')
<div class="card bg-default tarjeta animate__animated animate__fadeInLeft" id="propietario">
    <div class="card-body">
...
<div class="position-fixed bottom-0 start-0 p-3 animate__animated animate__fadeInUp animate__delay-2s	" style="z-index: 11">
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-animation="false" data-bs-autohide="false">
        ...
        <div class="toast-body">
            Recuerda que el fin de este registro es únicamente realizar un concepto de precio y no estás obligado a consignar tu inmueble
        </div>
    </div>
</div>
