            ...
            <div class="row ">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-7">
                            <input id="idnumber" name="idnumber" type="number" class="form-control" required="required" min="800">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group row" id="valorgrupo">
                        <label for="valor" id="valorlabel" class="col-5 col-form-label">¿Valor tentativo que le vas a
                            ...
                            al inmueble?</label>
                        <div class="col-7">
                            <input id="valor" name="valor" type="number" class="form-control" min="99000" required="required">
                ...
                <div class="col-12 col-md-6 border-right">
                    <div class="form-group row">
                        <label for="tiempo_inm" class="col-5 col-form-label">Años de
                            contruido</label>
                        <div class="col-7">
                            <input id="tiempo_inm" name="tiempo_inm" type="number" min="1" class="form-control" max="100" required="required">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6">
