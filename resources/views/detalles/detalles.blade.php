        ...
        <div class="row grupo seccion">
            ...
            <div class="col-12 col-md-4 ">
                <div class="form-group row">
                    ...
                    <div class="col-7">
                        <input id="a_construida" name="a_construida" type="number" step="0.1" min="11" class="form-control" required="required">
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 ">
                <div class="form-group row">
                    ...
                    <div class="col-7">
                        <input id="a_privada" name="a_privada" type="number" min="11" step="0.1" required="required" class="form-control">
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                ...
                <div class="form-group row" id="s3_terreno">
                    ...
                    <div class="col-7">
                        <input id="a_terreno" name="a_terreno" type="number" min="11" step="0.1" class="form-control" required>
                    </div>
                </div>
                @endif
            </div>
