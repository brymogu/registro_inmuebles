...
@section('content')
    <div class="card bg-default tarjeta shadow-lg animate__animated animate__fadeInUp" id="detalles">
        <div class="card-body">
            ...
            <div class="row grupo seccion">
                ...
                <div class="col-12 col-md-4">
                    <div class="form-group row border-end">
                        ...
                        <div class="col-7">
                            <input id="a_privada" name="a_privada" type="number" min="11" step="0.1" class="form-control"
                                required>
                        </div>
                    </div>
                </div>
            ...
            <div class="row grupo seccion">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group row border-end" id="cortina">
