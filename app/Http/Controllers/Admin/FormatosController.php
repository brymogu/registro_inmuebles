...
class FormatosController extends Controller
{
    public function cpvj($codineg)
    {
        ...
        if (isset($_SESSION['nombre'])) {
            ...
            return view('admin.descargas.cpvj', compact('datos', 'conc_juridico', 'todos_planes', 'acuerdos', 'codineg'));
        }
    ...
    public function update(Request $request)
    {
        ...
        $codineg = Negocios::find($request->codineg);
        //Negocio
